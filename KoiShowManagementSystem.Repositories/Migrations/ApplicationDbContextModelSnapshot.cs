...
{
    [DbContext(typeof(ApplicationDbContext))]  // Chỉ định DbContext sử dụng trong migration này
...
#pragma warning disable 612, 618
            modelBuilder
                ...
                .HasAnnotation("Relational:MaxIdentifierLength", 128);  // Thiết lập độ dài tối đa của tên bảng và cột

            SqlServerModelBuilderExtensions.UseIdentityColumns(modelBuilder);  // Cấu hình Identity column cho SQL Server

            // Định nghĩa mô hình cho bảng Event_Koi_Participations
            modelBuilder.Entity("KoiShowManagementSystem.Repositories.Entity.Event_Koi_Participation", b =>
                {
                    ...
                    b.HasKey("Id");  // Chỉ định khóa chính

                    b.HasIndex("EventsId");  // Tạo chỉ mục cho cột EventsId
                    b.HasIndex("KoiId");  // Tạo chỉ mục cho cột KoiId

                    b.ToTable("Event_Koi_Participations");  // Đặt tên bảng trong cơ sở dữ liệu
                });

            // Định nghĩa mô hình cho bảng Events
            ...
            // Định nghĩa mô hình cho bảng JudgeAssignments
            ...
            // Định nghĩa mô hình cho bảng Kois
            ...
            // Định nghĩa mô hình cho bảng Reports
            ...
            // Định nghĩa mô hình cho bảng Scores
            ...
            // Định nghĩa mô hình cho bảng Users
